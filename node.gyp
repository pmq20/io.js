  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        '../fast-hessian/include/hessian/pool.h',
        '../fast-hessian/src/hessian.cc',
        '../fast-hessian/src/hessian_pool.cc',
        ...
        '../fast-hessian/src/hessian_array.cc',
        '../fast-hessian/src/hessian_bool.cc',
        '../fast-hessian/src/hessian_bytes.cc',
        '../fast-hessian/src/hessian_double.cc',
        '../fast-hessian/src/hessian_hash_map.cc',
        '../fast-hessian/src/hessian_map.cc',
        '../fast-hessian/src/hessian_object.cc',
        '../fast-hessian/src/hessian_ref.cc',
        'src/async-wrap.cc',
        'src/cares_wrap.cc',
